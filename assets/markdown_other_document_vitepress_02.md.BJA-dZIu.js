import{_ as i,c as a,o as n,ae as l}from"./chunks/framework.CTbQKwUi.js";const r=JSON.parse('{"title":"二、配置文件","description":"","frontmatter":{},"headers":[],"relativePath":"markdown/other/document/vitepress/02.md","filePath":"markdown/other/document/vitepress/02.md"}'),p={name:"markdown/other/document/vitepress/02.md"};function h(k,s,t,E,e,d){return n(),a("div",null,s[0]||(s[0]=[l(`<h1 id="二、配置文件" tabindex="-1">二、配置文件 <a class="header-anchor" href="#二、配置文件" aria-label="Permalink to &quot;二、配置文件&quot;">​</a></h1><h2 id="_2-1-应用配置信息" tabindex="-1">2.1 应用配置信息 <a class="header-anchor" href="#_2-1-应用配置信息" aria-label="Permalink to &quot;2.1 应用配置信息&quot;">​</a></h2><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// https://vitepress.dev/reference/site-config</span></span>
